## Time-stamp: <2017-12-26 16:23:52 vk>
...
*** =pandoc=
This module optionally uses [[https://pandoc.org][Pandoc]] to convert the description of RSS items from HTML to Org sytax.
Installation differs depending on your environment, for instance ~apt get install pandoc~ or  ~brew install pandoc~.
